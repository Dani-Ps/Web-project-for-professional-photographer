/*!
 * modernizr v3.6.0
 * Build https://modernizr.com/download?-applicationcache-audio-audiopreload-backgroundsize-borderimage-borderradius-boxshadow-canvas-canvastext-capture-cssanimations-csscolumns-cssfilters-cssgradients-cssreflections-csstransforms-csstransforms3d-csstransitions-directory-fileinput-flexbox-fontface-formattribute-generatedcontent-geolocation-hashchange-history-hovermq-hsla-indexeddb-inlinesvg-input-inputformaction-inputformenctype-inputformmethod-inputformtarget-inputtypes-localizednumber-localstorage-multiplebgs-oninput-opacity-passiveeventlisteners-pointermq-postmessage-quotamanagement-rgba-search-sessionstorage-smil-svg-svgasimg-svgclippaths-svgfilters-textshadow-touchevents-video-videoautoplay-videoloop-videopreload-webgl-websockets-websocketsbinary-websqldatabase-webworkers-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
  ...
  function testDOMProps(props, obj, elem) {
    ...
    for (var i in props) {
      if (props[i] in obj) {
        ...
        if (props[i] === "persistent" && "storage" in navigator) {
          // Check if 'persistent' is supported using navigator.storage
